  ...
  return (
    <>
      ...
      <div className={className}>
        <p>
          {t<string>('You have been redirected because the Decentration extension believes that this website could compromise the security of your accounts and your tokens.')}
        </p>
